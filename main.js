...
export function setupContext(projectId) {
			...
			<div class=editor-header>
				...
				<div class="export">
					...
					${Tooltip(html `
						...
						</button>`, html `${isClient ? "Only host can export" : null}`, "", "bottom-end")}
				</div>
			</div>
