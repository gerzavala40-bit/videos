...
export const OmniAnim = shadow_component(use => {
    ...
    const [kind, setKind] = use.state("in");
    ...
    const renderAnimationNone = (type) => {
        return html `
				<div
    ...
    const renderDurationSlider = () => {
        ...
        return html `
			<div class=duration-slider>
				...
				<input
					@change=${(e) => manager.updateAnimation({ duration: +e.target.value, kind, effect: selectedImageOrVideoEffect })}
					type="range"
					min="520"
