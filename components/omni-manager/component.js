...
export class OmniManager extends LitElement {
    ...
    removeProject(projectId, prefix) {
				...
				<div class="projects">
					<div class=flex>
						...
						<a class="import-project">
							...
							<input type="file" id="fileInput" accept=".zip" @change=${async (e) => {
            const projectState = await this.project.importProject(e.target);
            if (projectState) {
					...
					${this.handleCollaborationUI(html `
						<div>
							...
							<input
								...
								@input=${(e) => { this.setInviteId(e.target.value); this.requestUpdate(); }}
							>
							<button
...
], OmniManager.prototype, "joiningInProgress", void 0);
__decorate([
    property()
], OmniManager.prototype, "sessionError", void 0);
__decorate([
    property({ type: String, attribute: false })
], OmniManager.prototype, "inviteID", void 0);
__decorate([
    property()
], OmniManager.prototype, "projects", void 0);
