...
export const ProposalIndicator = light_view(use => () => {
    ...
    function translate_to_timecode({ grabbed, position }) {
    ...
    use.mount(() => {
        const disposeDrop = effectDragHandler.onDrop(props => {
            ...
            const proposed_timecode = controller
                .calculate_proposed_timecode(timecode, props, use.context.state);
    ...
    return html `
		<div
			...
			style="
				...
				width: ${proposedTimecode.effects_to_push
        ? 0
...
//# sourceMappingURL=proposal-indicator.js.map