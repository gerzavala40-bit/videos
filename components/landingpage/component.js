...
export class LandingPage extends LitElement {
    ...
    transitionsVideo = null;
    interval = 0;
    // Toggle transitions dropdown
    toggleTransitionsDropdown = (e) => {
        e.stopPropagation();
    ...
    menuClick = (e) => {
        const hamburger = e.composedPath().find(e => e.className === "menu-icon");
        const navmenu = e.composedPath().find(e => e.className === "menu");
        if (hamburger)
            return;
        if (!navmenu) {
    ...
    firstUpdated() {
        const transitionDuration = 3.492;
        const video = this.shadowRoot?.querySelector(".transitions-video");
...
], LandingPage.prototype, "menuOpened", void 0);
__decorate([
    property({ type: String })
], LandingPage.prototype, "currentTransition", void 0);
__decorate([
    property({ type: Boolean })
], LandingPage.prototype, "transitionsDropdownOpen", void 0);
