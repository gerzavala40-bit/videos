...
export class Timeline {
    ...
    #placementProposal;
    #effectManager;
    constructor(actions, media, compositor) {
    ...
    */
    calculate_proposed_timecode(effectTimecode, drag, state) {
    ...
    */
    set_proposed_timecode(dragProps, proposedTimecode, state) {
    ...
    */
    set_selected_effect(effect, state) {
